        ...
        child: Column(
          ...
          children: [
            ...
            Hero(tag: catData.id ?? 'Cat Breed',
              child: ClipRRect(
                borderRadius: BorderRadius.circular(15),
                child: Image.network("https://cdn2.thecatapi.com/images/${catData.referenceImageId}.jpg",
                  loadingBuilder: (context, child, loadingProgress) {
                    ...
                    return SizedBox(height: 300,width: double.infinity,child: Image.asset("assets/cat.png"),);
                  },),
              ),
            ),
            const SizedBox(height: 10),
